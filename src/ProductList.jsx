...
function ProductList({ onHomeClick }) {
  ...
  useEffect(() => {
    // Reset the addedToCart state when the cart changes
    const newAddedToCart = {};
    cart.forEach((item) => {
      newAddedToCart[item.name] = true; // Mark each item in the cart as added
    });
    setAddedToCart(newAddedToCart);
  }, [cart]); // Dependency array to run this effect whenever the cart changes
